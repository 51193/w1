...
namespace MyGame.Manager
{
	...
	public partial class MapTransition : Node
	{
		...
		[Signal]
		public delegate void TransitMapEventHandler(string departureName, string exitName, Vector2 exitPosition, BaseEntity entity);
		[Signal]
		...
		private void InvokeManagers(string destinationName, string fromLandmarkName, string toLandmarkName, BaseEntity entity)
		{
